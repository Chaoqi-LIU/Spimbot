...
left_clean_sides:
    ...
    li  $a1, 270
    jal move_bot
    # li  $t0, 0x00040002           <<<<<< final modified
    # sw  $t0, POWERWASH_ON
    # ========== water on ==========
    li  $t0, 0x00040002
    sw  $t0, POWERWASH_ON
...
queen_placed: .space 384000
# curr_placed: .word 0x10200180
row_placed: .word 0x10200180
col_placed: .word 0x10200190
left_diag_placed: .word 0x102001A0
right_diag_placed: .word 0x102001C0
